    ...
    <a-card :bordered="false">
      <div class="table-page-search-wrapper">
        ...
        <a-form layout="inline">
          <a-row :gutter="96">
            <a-col :md="8" :sm="24">
              <a-form-item class="xrequired" label="身份证号">
                <a-input v-model="queryParam.name" placeholder=""/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item class="xrequired" label="姓名">
                <a-input v-model="queryParam.name" placeholder=""/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item class="xrequired" label="身份证地址">
                <a-input v-model="queryParam.idAddress" placeholder=""/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item class="xrequired" label="性别">
            ...
            <br>
            <a-col :md="8" :sm="24">
              <a-form-item class="xrequired" label="政治面貌">
            ...
            <a-col :md="8" :sm="24">
              <a-form-item class="xrequired" label="岗位">
                <a-input v-model="queryParam.post"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item class="xrequired" label="人员类型">
            ...
            <a-col :md="8" :sm="24">
              <a-form-item  label="是否需要签到">
                ...
                <input class="distance" type="radio" name="radios" value="0" v-model="need"><label>不需要</label>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item label="专业">
                <a-input v-model="queryParam.major"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
            ...
            <a-col :md="8" :sm="24">
              <a-form-item class="xrequired" label="班组">
                <a-input v-model="queryParam.groupnumber"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item class="xrequired" label="从事工种">
                <a-input v-model="queryParam.craft"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item class="xrequired" label="工资待遇">
                <a-input v-model="queryParam.salary"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item class="xrequired" label="工作时间">
                <a-input v-model="queryParam.time" placeholder="小时/天"/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
              <a-form-item label="合同起止时间">
                <a-date-picker v-model="queryParam.date" style="width: 40%" />-
                <a-date-picker v-model="queryParam.date" style="width: 40%" />
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24">
            ...
            <a-col :md="8" :sm="24">
              <a-form-item label="劳务合同编号">
                <a-input v-model="queryParam.contractnumber"/>
              </a-form-item>
            </a-col>
            <a-col :md="24" :sm="24">
